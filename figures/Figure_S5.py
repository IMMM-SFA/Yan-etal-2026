...
fig, axes = plt.subplots(2, 2, figsize=(11, 7.5), layout='compressed')
axes = axes.flatten()
...
axes[2].set_xlabel('Region', fontsize=11)
axes[3].set_xlabel('Region', fontsize=11)

plt.savefig('land_cover_by_region.png', dpi=150)
print('saved')